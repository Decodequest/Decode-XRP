...
import React from "react";
  ...
  const Course = [
    { 
        ...
        details: "Skills to unlock: Blockchain Understanding, Security Practices, API Utilisation, Strategic Analysis",
    ...
    { 
        ...
        details: "Skills to unlock: Cryptocurrency Literacy, Fin tech Insight, Risk Management, Global Payment Systems",
    ...
    { 
        ...
        details: "Skills to unlock: Wallet Management, Security Awareness, Technical Proficiency, Decision Making",
                ...
                <div className="relative w-full pl-4">
                    <div className="text-blue">
                        ...
                        {/* <div className="absolute left-16 bottom-[130px] flex text-white">
                            <button className="mr-8 bg-white text-black font-semibold rounded-md py-3 px-6">Start Learning</button>
                                    ...
                                    <Link href={details.link}>    
                                        ...
                                        <div className="pl-4 w-[487px] mt-4">
                                            <div className="flex justify-between">
                                                <div>
                                                    <h1 className="text-[20px] inline">{details.heading}</h1>
                                                    <p className="bg-[#1E1E1E] w-[50px] inline ml-4 p-2 text-sm">10XP</p>
                                                </div>
                                                <div>
                                                    <img className="inlinejustify-end" src="/nextArrow.png"/>
                                                </div>
                                            </div>
                                            <p className="pt-2 text-[16px] text-[#B8B8B8]">{details.details}</p>
                                            </div>
                                        </div>
                                    </Link>
                                )
